var teksSekarang = 1;var ftom=0;var pesanwhatsapp = "";const body = document.querySelector("body"); audio = new Audio('' + linkmp3.src); 
  ...
  varteks = teks7.innerHTML; teks7.innerHTML = "";
  function katanimasi(){
    new TypeIt("#teks7", {
    strings: ["" + varteks], startDelay: 250, speed: 30, cursor: true,
    afterComplete: function(){
      clearInterval(scrollInterval);
      teks7.innerHTML = varteks;
      setInterval(berjatuhan, 200);
        stiker7.style = "transform:scale(0);opacity:0;transition:all .8s ease;margin-top:180px";
        setTimeout(function(){
          stiker7a.src = stiker7b.src;
          stiker7.style = "transition:all .8s ease;margin-top:180px";
  ...
  var tomlv = document.querySelector(".awalan");
